                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <div class="status-badge {{ 
                            ...
                            ($kasus->status == 'Diproses' ? 'process' : 
                            ($kasus->status == 'Dikonfirmasi' ? 'confirmed' : 
                            ($kasus->status == 'Ditolak' ? 'rejected' : 'pending'))) 
                        }}">
                            <i class="fas {{ $kasus->status == 'Selesai' ? 'fa-check-double' : ($kasus->status == 'Diproses' ? 'fa-tools' : ($kasus->status == 'Dikonfirmasi' ? 'fa-check' : ($kasus->status == 'Ditolak' ? 'fa-times' : 'fa-clock'))) }}"></i>
                        ...
                        @switch($kasus->status)
                            ...
                            @case('Dikonfirmasi')
                                <div class="alert alert-info">
                                    ...
                                    <strong>{{ \Carbon\Carbon::parse($kasus->tanggal_penanganan)->isoFormat('D MMMM Y') }}</strong>.</p>
                                ...
                                <div class="alert alert-primary">
                                    ...
                                    <div class="timeline mt-3">
                                        <div class="timeline-item">
                                            ...
                                            {{ \Carbon\Carbon::parse($kasus->tanggal_penanganan)->isoFormat('D MMMM Y') }}
                                        </div>
                                    </div>
                                ...
                                <div class="alert alert-success">
                                    ...
                                    <div class="timeline mt-3">
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            {{ \Carbon\Carbon::parse($kasus->tanggal_selesai)->isoFormat('D MMMM Y') }}
                                        </div>
                                    </div>
                                    @if($kasus->catatan_satgas)
                                        <p class="mt-3"><strong>Hasil Penanganan:</strong><br>
                                        {{ $kasus->catatan_satgas }}</p>
                                    @endif
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <span class="badge 
                                            {{ $kasus->status == 'Selesai' ? 'badge-success' : 
                                                ($kasus->status == 'Diproses' ? 'badge-primary' : 
