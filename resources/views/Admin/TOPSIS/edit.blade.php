...
@section('title', 'Edit Kriteria TOPSIS')

@section('content')
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Kriteria TOPSIS</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.topsis.update', $kriteria->id_kriteria) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row nilai-kriteria-item mb-3">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="nilai_kriteria[{{ $index }}][id]" 
