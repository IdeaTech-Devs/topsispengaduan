    ...
    <div class="col-md-8">
        <div class="card shadow mb-4 profile-card">
            <div class="card-header py-3 profile-header">
                <h6 class="m-0 font-weight-bold text-light">Profil Saya</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('kemahasiswaan.update-profil') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="profile-form-group">
                        <label>Nama</label>
                        <input type="text" name="nama" class="form-control profile-input @error('nama') is-invalid @enderror" 
                    ...
                    <div class="profile-form-group">
                        <label>Email</label>
                        <input type="email" name="email" class="form-control profile-input @error('email') is-invalid @enderror" 
                    ...
                    <div class="profile-form-group">
                        <label>No. HP</label>
                        <input type="text" name="telepon" class="form-control profile-input @error('telepon') is-invalid @enderror" 
                    ...
                    <div class="profile-form-group">
                        ...
                        <select name="fakultas" class="form-control profile-select @error('fakultas') is-invalid @enderror" required>
                            @foreach(['Teknik', 'Hukum', 'Pertanian', 'Ilmu Sosial dan Ilmu Politik', 
                                    'Keguruan dan Ilmu Pendidikan', 'Ekonomi dan Bisnis', 
                                    'Kedokteran dan Ilmu Kesehatan', 
                                    'Matematika dan Ilmu Pengetahuan Alam'] as $fakultas)
                                <option value="{{ $fakultas }}" 
                                    {{ old('fakultas', $kemahasiswaan->fakultas) == $fakultas ? 'selected' : '' }}>
                                    {{ $fakultas }}
                                </option>
                            @endforeach
                        </select>
...
<div class="modal fade" id="resetPasswordModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('kemahasiswaan.update-password') }}">
                @csrf
                @method('PUT')
